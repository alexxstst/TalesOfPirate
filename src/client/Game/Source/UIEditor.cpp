...
bool CEditor::Init()
{
    ...
    char buf[10] = { 0 };
    _itoa(g_Editor.m_nBrushHeight, buf, 10);
...
void CEditor::_TreeEvent(CTreeView* tree, bool press )
{
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(528) )==0 )
    {
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(529) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(530) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
        if( p ) 
        {
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(531) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
        if( p ) 
        {
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(532) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
        if( p && press ) 
        {
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(533) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(534) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
        if( p ) 
        {
    ...
    if( _stricmp(item->GetString().c_str(), g_oLangRec.GetString(535))==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
        if( p )
        {
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(538) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(539) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );
    ...
    if( _stricmp( item->GetString().c_str(), g_oLangRec.GetString(540) )==0 )
    {
        CGraph *p = dynamic_cast<CGraph*>( tree->GetSelect()->GetItem() );

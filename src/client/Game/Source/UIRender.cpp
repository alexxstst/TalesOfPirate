...
// class CGuiPic
//---------------------------------------------------------------------------
bool CGuiPic::LoadImage( MPTexRect* pTex, const std::string& file, int w, int h, int tx, int ty, float scale_x, float scale_y )
{
...
bool CGuiPic::LoadAllImage( const std::string& file, int w, int h, int tx, int ty )
{
...
bool CGuiPic::LoadImage( const std::string& file, int w, int h, int frame, int tx, int ty, float scalex, float scaley )
{
	int id = GetTextureID( file );
...
bool CGuiPic::LoadImage( const std::string& file )
{
	int id = GetTextureID( file );
	if( id == -1 ) return false;
...
bool CFramePic::LoadImage( const std::string& client, int cw, int ch, int tx, int ty, const std::string& file, int w, int h )
{
...
void CGuiFont::SetScreen( int nScrWidth, int nScrHeight )
{
	...
	{
		for( auto it=_stfonts.begin(); it!=_stfonts.end(); ++it )
		{
			p =  new CMPFont;
#ifdef USE_RENDER
...
// class CTextButton
//---------------------------------------------------------------------------
bool CTextButton::LoadImage( const std::string& file, int w, int h, int tx, int ty, bool isHorizontal )
{
...
// class CScroll
//---------------------------------------------------------------------------
bool CScroll::LoadImage( const std::string& bkg, const std::string& up, const std::string& scroll, const std::string& down, int w, int h )
{
...
bool CProgressBar::LoadImage( const std::string& file, int w, int h, bool isHorizontal )
{
	if( !_pImage ) return false;
...
bool CFormMgr::Init(HWND hWnd)
{
	if( !_bInit )
	{
		...
		for( auto it=_vinits.begin(); it!=_vinits.end(); it++ )
		{
			if( !(*it)(this) )
				return false;
		}

...
{
	FORM_LOADING_CHECK(m_pGuildMgrForm,"manage.lua","frmManage");
	FORM_LOADING_CHECK(m_pGuildPermForm,"manage.lua","frmGuildPerm");
	m_pGuildMgrForm->evtBeforeShow=OnBeforeShow;

	FORM_CONTROL_LOADING_CHECK(m_plabGuildName,m_pGuildMgrForm,CLabelEx,"manage.lua","labName");
	FORM_CONTROL_LOADING_CHECK(m_plabGuildMottoName,m_pGuildMgrForm,CLabelEx,"manage.lua","labMaxim");
	//FORM_CONTROL_LOADING_CHECK(m_plabGuildType,m_pGuildMgrForm,CLabelEx,"manage.lua","labState");
	FORM_CONTROL_LOADING_CHECK(m_plabGuildMaster,m_pGuildMgrForm,CLabelEx,"manage.lua","labPeople");
	FORM_CONTROL_LOADING_CHECK(m_plabGuildMemberCount,m_pGuildMgrForm,CLabelEx,"manage.lua","labNum");
	//FORM_CONTROL_LOADING_CHECK(m_plabGuildState,m_pGuildMgrForm,CLabelEx,"manage.lua","labReason");
	//FORM_CONTROL_LOADING_CHECK(m_plabGuildRemainTime,m_pGuildMgrForm,CLabelEx,"manage.lua","labRemain");
	FORM_CONTROL_LOADING_CHECK(m_pbtnGuildMottoEdit,m_pGuildMgrForm,CTextButton,"manage.lua","btnMaxim");
	FORM_CONTROL_LOADING_CHECK(m_pbtnGuildDisband,m_pGuildMgrForm,CTextButton,"manage.lua","btnDisband");
	FORM_CONTROL_LOADING_CHECK(m_pbtnGuildLeave, m_pGuildMgrForm, CTextButton, "manage.lua", "btnLeave");
	FORM_CONTROL_LOADING_CHECK(m_pbtnMemberRecruit,m_pGuildMgrForm,CTextButton,"manage.lua","btnYes");
	FORM_CONTROL_LOADING_CHECK(m_pbtnMemberRefuse,m_pGuildMgrForm,CTextButton,"manage.lua","btnNo");
	FORM_CONTROL_LOADING_CHECK(m_pbtnMemberKick,m_pGuildMgrForm,CTextButton,"manage.lua","btnkick");
	FORM_CONTROL_LOADING_CHECK(m_plstGuildMember,m_pGuildMgrForm,CListView,"manage.lua","lstNum");
	FORM_CONTROL_LOADING_CHECK(m_plstRecruitMember,m_pGuildMgrForm,CListView,"manage.lua","lstAsk");
	FORM_CONTROL_LOADING_CHECK(m_ppgeClass,m_pGuildMgrForm,CPage,"manage.lua","pgePublic");
	
	FORM_CONTROL_LOADING_CHECK(m_pbtnMemberYesPerms,m_pGuildPermForm,CTextButton,"manage.lua","btnYesPerm");
	FORM_CONTROL_LOADING_CHECK(m_pbtnMemberPerms,m_pGuildMgrForm,CTextButton,"manage.lua","btnperm");
	...
	FORM_LOADING_CHECK(m_pGuildMottoNameEditForm,"manage.lua","frmEditMaxim");
	FORM_CONTROL_LOADING_CHECK(m_pedtGuildMottoName,m_pGuildMottoNameEditForm,CEdit,"manage.lua","edtMaxim");
	FORM_CONTROL_LOADING_CHECK(m_pbtnGuildMottoFormOK,m_pGuildMottoNameEditForm,CTextButton,"manage.lua","btnYes");
	...
	// Guild Vault logs:
	FORM_CONTROL_LOADING_CHECK(m_plistBankLog,m_pGuildMgrForm,CListView,"manage.lua","listBankLog");
	FORM_CONTROL_LOADING_CHECK(m_btnNext, m_pGuildMgrForm, CTextButton, "manage.lua", "btnNext");
	FORM_CONTROL_LOADING_CHECK(m_btnPrev, m_pGuildMgrForm, CTextButton, "manage.lua", "btnPrev");

...
BOOL CGameApp::_Init()
{
    ...
    {
        ToLogService("init", "{}", g_oLangRec.GetString(65));
    }
	...
	{
		ToLogService("init", "{}", g_oLangRec.GetString(68));
		return FALSE;
	}
	...
	if( !CFormMgr::s_Mgr.Init( g_pGameApp->GetHWND() ) )    // by lh CLU_LoadScript
	{
		ToLogService("init", "{}", g_oLangRec.GetString(69));
		return FALSE;
	}
	...
	{
		ToLogService("init", "{}", g_oLangRec.GetString(70));
		return FALSE;
	}
	...
	{
		ToLogService("init", "msgCGameScene::_InitScene() return false");
		return false;
	}
...
#pragma message("-------------Primitive Culling Closed-------------")
    ...
    // (Modify by Michael Chen 2005-04-27)
	...
	// (Modify by Michael Chen 2006-01-17)
...
void CGameApp::_End()
{
    ...
    ToLogService("end", "NetIF release start");
    SAFE_DELETE( g_NetIF );
    ToLogService("end", "NetIF release end");

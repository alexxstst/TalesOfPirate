...
{
public:
	CGraph(const std::string& file, int w, int h, int sx, int sy, int maxframe) : nTag(0) {
...
public:
	...
	const std::string&     GetString()					{ return _strName.c_str();	}
...
public:
	...
	virtual void	SetString( const std::string& str ){ _strName=str;				}
	const std::string&     GetString()					{ return _strName;	}

...
public:	// Get,Set
	...
	void			ReplaceSel( const std::string& str, BOOL bCanUndo=TRUE );

	virtual void	SetTextColor( std::uint32_t color );
	DWORD			GetTextColor()		{ return _color;			}

	void			SetCursorColor( std::uint32_t  v )	{ _nCursorColor = v;}

...
public:	// 
	...
	bool	LoadImage( const std::string& file, int w, int h, int frame=0, int tx=0, int ty=0, float scalex=0.0, float scaley=0.0 );
	bool	LoadAllImage( const std::string& file, int w, int h, int tx=0, int ty=0 );
	...
	static bool LoadImage( MPTexRect* pTex, const std::string& file, int w, int h, int tx=0, int ty=0, float scale_x=1.0, float scale_y=1.0 );
...
CFramePic( CGuiData *pOwn );
	...
	// w,hclientcw,ch
	bool		LoadImage( const std::string& client, int cw, int ch, int tx, int ty, const std::string& file, int w, int h );

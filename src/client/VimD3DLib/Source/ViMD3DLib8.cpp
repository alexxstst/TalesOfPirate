...
typedef BOOL (*FN_ViMD3D_Create8)(IDirect3DDevice9*, VIMD3D*);
typedef BOOL (*FN_ViMD3D_Release8)(VIMD3D);
typedef BOOL (*FN_ViMD3D_RasterTextures8)(VIMD3D, DWORD, DWORD, DWORD, DWORD, DWORD, IDirect3DTexture9**);
typedef BOOL (*FN_ViMD3D_RasterTexturesUV8)(VIMD3D, DWORD, DWORD, DWORD, DWORD, DWORD, IDirect3DTexture9**, float* uv);
	...
	if (szError) {
		...
		case 0:
			*szError = 0;
			break;
		case 1:
			lstrcpy(szError, _T("Could not load ViMD3DLib.dll or library broken."));
			break;
		case 2:
			lstrcpy(szError, _T("Wrong version of ViMD3DLib.dll."));
			break;
		case 3:
			lstrcpy(szError, _T("No valid license found."));
			break;
		case 4:
			lstrcpy(szError, _T("No WiseVision 3d display configured."));
			break;
		default:
			lstrcpy(szError, _T("Unknown error."));
			break;
		}
	}

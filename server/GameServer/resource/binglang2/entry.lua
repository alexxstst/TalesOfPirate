...
function after_create_entry(entry) 
    ...
    Notice("Announcement: Some players have discovered that on Deep Blue region at ["..posx..","..posy.."] emerges a portal that leads to [Icicle Mirage]. All players beware!") --
...
function after_player_login_binglang2(entry, player_name)
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) --
    ChaNotice(player_name, "Announcement: Some players have discovered that on Deep Blue region at ["..posx..","..posy.."] emerges a portal that leads to [Icicle Mirage]. All players beware!") --

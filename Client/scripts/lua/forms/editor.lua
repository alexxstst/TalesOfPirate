...
start = start + 18
-- Toggle display: teleport, brush height, etc.
...
-- Island index input (added by claude)
cld_xpos = 200
cld_ypos = 50
...
-- Reset region attribute checkbox
cld_xpos = cld_xpos + 50
...
itemid = UI_CreateTextItem( "earth surface", TREE_TEXT_COLOR )
...
sndNode = UI_CreateSingleNode( trvEditor, itemid, -1 )
	...
	n  = 1	
	local valid_cnt = 0 -- Valid character count
	while 1 do

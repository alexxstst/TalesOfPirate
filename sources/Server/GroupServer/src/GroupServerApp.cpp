...
// AcctClientHandler:   AccountServer  
void GroupServerApp::AcctClientHandler::OnDisconnected(int reason) {
	std::cout << "[GroupServer] AccountServer , reason=" << reason << std::endl;
...
void GroupServerApp::OnPacket(net::TcpClient* client, net::RPacket& pkt)
{
	...
	if (sess > 0 && !(sess & 0x80000000)) {
		// Incoming RPC (GateServer  GroupServer)    SESS|FLAG

...
public:
	struct SMgrUnit
	{
		...
		dbc::Long	lLeftTick1;	// ʣ��ʱ��
		dbc::Long	lLeftTick2;	// ʣ��ʱ��
		dbc::Char	chAction;	// ��ʱ���ж�
		CCharacter	*pCCha;
		dbc::uLong	ulChaID;
...
public:
	...
	bool		CheckRun(void);
	void		DealActivePlayer(std::string & function);//2006.10.12wsj�����Ҷ������ǵ�ʤ��.
	...
	void	InactiveEyeshotCell(dbc::Long lCellX, dbc::Long lCellY)
	{
		...
		if (m_pCEyeshotCell[lCellY][lCellX].m_lActNum == 0)
		{
			if (CountEyeshotPlyActiveNum(lCellX, lCellY) > 0) // ������Ұ�������ҽ�ɫ�����������Ӧ�ó���
			{
				m_pCEyeshotCell[lCellY][lCellX].m_lActNum++;
				//LG("��Ұ�������", "!!!��Ұ��Ԫ[%d,%d]ֹͣ����ʱ���������д�������Ұ��������ҽ�ɫ\n", lCellX, lCellY);
	...
	CEyeshotCell	**m_pCEyeshotCell; // ��Ұ��Ԫ
	CStateCell		***m_pCStateCell; // ״̬��Ԫ
	COutMapCha		m_COutMapCha; // ��ͼ���ɫ
	//��������ʵĵ�ͼ��Ϣ����
	CActEyeshotCell	m_CEyeshotCellL;	// �������Ұ��Ԫ�б�
	CActStateCell	m_CStateCellL;		// �����״̬��Ԫ�б�
...
private:
	...
	struct
	{
		bool				m_bIncludeHideEnti;							// �Ƿ�����������ʵ��
		dbc::Short			m_sRangeMgrUnitNum;							// ��Χ�ڹ�����Ԫ����Ŀ
		dbc::Long			m_lRangeMgrUnit[defRANGE_MGRUNIU_NUM][2];	// ��Χ�ڵĹ�����Ԫ����б���x,y��
		dbc::Long			m_lRangeCentUnit[2];						// ��Χ���ĵ�Ԫ;
		dbc::Short			m_sRangeCurMgrUnit;							// ���������У���ǰ�Ĺ�����Ԫ
		CChaListNode*		m_pRangeCurEntiNode;						// ���������У���ǰ��ʵ��

...
/*
	Class OuterServerGateServer
	OuterServerStructGameServerApp
*/
...
private:
	...
	bool	OnConnect(DataSocket *datasock);				//:true-,false-
	void	OnDisconnect(DataSocket *datasock,int reason);	//reason:0--3--1-Socket;-5-

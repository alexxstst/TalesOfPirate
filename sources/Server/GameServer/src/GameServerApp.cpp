...
void GameServerApp::HandlePendingEvents()
{
    ...
    if (di >= 0 && di < m_gtnum)
    {
        ...
        {
            //  :     Gate  GateServer
            auto wpkt = net::msg::serializeGmGateDisconnect(0);
            net::RPacket rpkt(wpkt.Data(), wpkt.GetPacketSize(), false);
...
bool GameServerApp::SendToWorld(net::WPacket& chginf)
{
    for (int i = 0; i < m_gtnum; ++i)
    {
        ...
        net::WPacket CChginf = chginf.Duplicate();
        short sCount = 0;
...
bool GameServerApp::SendToClient(net::WPacket& pkt, std::span<CPlayer* const> recipients)
{
